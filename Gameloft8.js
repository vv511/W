...
**************************************
[rewrite_local]
#! ^https:([\S\s]*?)gameloft.com/scripts/general/sync_all.php url script-response-body https://github.com/vv511/W/blob/main/Gameloft8.js
#! ^https:([\S\s]*?)gameloft.com/scripts/energy/pre_tle_race.php url script-response-body https://github.com/vv511/W/blob/main/Gameloft8.js
^https:([\S\s]*?)gameloft.com/configs/users/me url script-response-body https://github.com/vv511/W/blob/main/Gameloft8.js
^https:([\S\s]*?)unityads.unity3d.com/([\S\s]*?)/config.json url script-response-body https://github.com/vv511/W/blob/main/Gameloft8.js

^https:([\S\s]*?)gameloft.com/scripts url script-response-body https://github.com/vv511/W/blob/main/Gameloft8.js
^https:([\S\s]*?)gameloft.com/profiles/me/myprofile url script-response-body https://github.com/vv511/W/blob/main/Gameloft8.js
